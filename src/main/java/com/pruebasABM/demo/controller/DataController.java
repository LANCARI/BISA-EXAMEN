...
public class DataController {
	...
	public ResponseEntity getData(){
		...
		if (global.getClientes().isEmpty()) {
			...
			Referencia referencia1 = new Referencia(1, persona3, cliente1, "personareferencia@gmail.com", "524566", "madre", "Activo","" );
			global.setReferencia(referencia1);

			Referencia referencia2 = new Referencia(2, persona4, cliente2,"personareferencia@gmail.com", "7864534", "padre", "Activo","" );
			global.setReferencia(referencia2);

			Referencia referencia3 = new Referencia(3, persona5, cliente2,"personareferencia@gmail.com", "524566", "madre", "Activo","" );
			global.setReferencia(referencia3);

			Referencia referencia4 = new Referencia(4, persona6, cliente3,"personareferencia@gmail.com", "7864534", "padre", "Activo","" );
			global.setReferencia(referencia4);

			Referencia referencia5 = new Referencia(5, persona7, cliente3,"personareferencia@gmail.com", "785645", "hoja", "Activo","" );
			global.setReferencia(referencia5);

			Referencia referencia6 = new Referencia(6, persona8, cliente3,"personareferencia@gmail.com", "578645", "tia", "Activo","" );
